	...
	AuthenticationResult>
{
	...
	public static (string?, bool) Validation_User(
		string? login,
		string? password,
		string? email,
		string? lastName,
		string? firstName)
	{
		...
		if (email.Length > 50)
			return ("Максимальная длина почты 50 символов",
				false);

		if (lastName.Length > 50)
			return (
				"Максимальная длина фамилии 50 символов",
				false);

		if (firstName.Length > 50)
			return ("Максимальная длина имени 50 символов",
				false);
